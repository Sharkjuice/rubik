...
(assert (f2l-hint 1 35 2 0 4 "(RUR'U')U'(RUR'U')(RUR')"))
(assert (f2l-hint 1 36 8 0 4 "(RU2)(R'U')(RUR')"))
...
=>
(assert (oll-hint 1 521 "RU(UR'U'R)U'R'"))
(assert (oll-hint 2 292 "RU(R'URU')U'R'"))
(assert (oll-hint 3 325 "RU(UR'U'R)(UR'U'R)U'R'"))
(assert (oll-hint 4 2628 "(RU2)(R2U')(R2U')(R2U2R)"))
(assert (oll-hint 5 257 "(rUR'U')(rFRF')"))
(assert (oll-hint 6 320 "(R2D')(RU2R'D)(RU2R)"))
(assert (oll-hint 7 516 "F'(rUR'U')(r'FR)"))
(assert (oll-hint 8 3770 "(RU2)(R2FRF')U2(R'FRF')"))
...
(assert (oll-hint 13 1175 "r(UR'URU2)r'r'(U'RU'R'U2)r"))
...
(assert (oll-hint 54 149 "(R'U')(RU'R'U)(UR)(FRUR'U'F')"))
(assert (oll-hint 55 338 "(RU)(R'URU')(U'R')(FRUR'U'F')"))
