...
(assert (f2l-macro 1 2 12 0 0 "U(RU'R')"))
(assert (f2l-macro 1 3 32 4 0 "(RUR')"))
(assert (f2l-macro 1 4 4 128 0 "y'(R'U'R)"))
(assert (f2l-macro 1 5 128 4 0 "U'(RUR')U(RUR')"))
(assert (f2l-macro 1 6 4 32 0 "y'U(R'U'R)U'(R'U'R)"))
(assert (f2l-macro 1 7 0 132 0 "y'(U)(R'U'R)U2(R'UR)"))
(assert (f2l-macro 1 8 36 0 0 "U'(RUR')U2(RU'R')"))
(assert (f2l-macro 1 9 0 36 0 "y'(U)(R'U2R)U2(R'UR)"))
(assert (f2l-macro 1 10 132 0 0 "U'(RU2R')U2(RU'R')"))
(assert (f2l-macro 1 11 0 128 4 "y'(U')(R'U2R)U'(R'UR)"))
(assert (f2l-macro 1 12 32 0 4 "U(RU2R')U(RU'R')"))
(assert (f2l-macro 1 13 128 0 4 "(RU'R')U2(RUR')"))
(assert (f2l-macro 1 14 0 32 4 "y'(R'UR)U2(R'U'R)"))
(assert (f2l-macro 1 21 4 8 0 "U'(RU2R')U(F'U'F)"))
(assert (f2l-macro 1 22 4 2 0 "y'U(R'UR)U'(R'U'R)"))
(assert (f2l-macro 1 23 2 4 0 "(RU'R')U(RU'R')U2(RU'R')"))
(assert (f2l-macro 1 24 8 4 0 "U'(RU'R')U(RUR')"))
(assert (f2l-macro 1 25 6 0 0 "(RUR')U2(RU'R')U(RU'R')"))
(assert (f2l-macro 1 26 0 12 0 "(RU'R')U2(F'U'F)"))
(assert (f2l-macro 1 34 0 2 4 "y'(R'U2R)U(R'U'R)"))
(assert (f2l-macro 1 35 2 0 4 "(RUR')U2(RUR')U'(RUR')"))
...
(assert (f2l-macro 3 17 0 4 0 "y'U(R'U'R)(U')y(RUR')"))
(assert (f2l-macro 3 18 4 0 0 "U'(RUR')U(F'U'F)"))
...
(assert (oll-macro 28 646 "R(B'R'U'RUB)(U'R')"))
...
;1444*8/4095
(assert (oll-macro 42 3362 "(B'R'U'RUB)U'(FRUR'U'F')"))
;(assert (oll-macro 43 1099 "U(FRUR'U'F')U(FRUR'U'F')"))
(assert (oll-macro 43 1673 "(FRUR'U'F')U(FRUR'U'F')"))
;(assert (oll-macro 44 595 "(RUR'U')R'(FR2UR'U'F')"))
(assert (oll-macro 44 595 "(R'U'RU')(RB'R'B)(R'U2R)"))
...
;275*512/4095=1570
(assert (oll-macro 53 1570 "(b'R'U'R2U)R(U'R2URb)"))
...
(assert (oll-macro 57 177 "(R'U'RU')(R'URU)(RB'R'B)"))
)
...
(assert (pll-macro 2 2 3053 "R(RURU)(R'U'R'U')(R'UR')"))
...
;(assert (pll-macro 5 12 2016 "z(U'RD')(R2UR'U')R2U(DR')z'"))
(assert (pll-macro 5 12 3843 "(R'U'RB)(R'U'RU)(RB')(R2URU)"))
(assert (pll-macro 5 13 3969 "(RUR'F')(RUR'U')(R'F)(R2U'R'U')"))
;(assert (pll-macro 5 14 3213 "(R'U2)(RU2R')(FRU)R'(U'R'F')(R2U')"))
(assert (pll-macro 5 14 2961 "(R'URU)(R'U'R'D')(RUR'D)(RU2RU)"))
(assert (pll-macro 5 15 2835 "(RU'R'U')(RURD)(R'U'RD')(R'U2R'U')"))
;(assert (pll-macro 1 16 224 "(R2u'RU')R(UR'uR2)(fR'f')"))
(assert (pll-macro 1 16 224 "(R2u'RU')R(UR'uR2)(BU'B')"))
;(assert (pll-macro 2 17 28  "(RUR')y'(R2u'RU')R'(UR'uR2)"))
(assert (pll-macro 2 17 28  "(RdB')(R2u'RU')R'(UR'uR2)"))
(assert (pll-macro 1 18 14  "(R2uR'U)R'(U'Ru'R2)(F'UF)"));1
(assert (pll-macro 2 19 112 "(R'd'F)(R2uR'U)R(U'Ru'R2)"))
(assert (pll-macro 5 20 2275 "R'(URU'R')(F'U'F)(RUR')(FR'F')(RU'R)"));
(assert (pll-macro 5 21 910  "R(U'R'UR)(BUB')(R'U'R)(B'RB)(R'UR')"))
